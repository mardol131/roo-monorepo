...
export default function OfferItem({ offer }: OfferItemProps) {
  ...
  return (
    <div className="border border-zinc-200 rounded-lg p-6 flex flex-col gap-6 transition-all">
      <div className="grid grid-cols-2 gap-15">
        <div>
          {/* Carousel */}
          <div className="relative w-full aspect-video rounded-lg overflow-hidden bg-zinc-100 mb-6">
            <Image
          ...
          <div className="flex items-center justify-between gap-4">
            {offer.availableDate && (
              <div className="flex items-center gap-2">
                ...
                <div>
                  <Text variant="label2" color="secondary" className="text-xs">
