...
export default async function page() {
  const t = await getTranslations("pages.forEntertainment");
  ...
  return (
    <>
      ...
      <LandingSectionWrapper>
        <ManifestoSection quote="Zábava začíná dřív, než akce začne. Začíná ve chvíli, kdy ji lidé najdou na správném místě." />
      </LandingSectionWrapper>
