...
export default async function page() {
  const t = await getTranslations("pages.howItWorksForUser");
    ...
    <>
      ...
      <LandingSectionWrapper>
        <BenefitsSection
          ...
          cta={{ text: t("cta.primaryCta"), href: "/register" }}
          benefits={[
            {
      ...
      <LandingSectionWrapper>
        <FeaturesSection
          ...
          features={[
            {
              icon: "CalendarDays" as LucideIcons,
            ...
            {
              icon: "ClipboardList" as LucideIcons,
              title: t("features.feature4.title"),
              description: t("features.feature4.description"),
            },
            {
              icon: "Heart" as LucideIcons,
              title: t("features.feature5.title"),
              description: t("features.feature5.description"),
            },
            {
              icon: "BadgeCheck" as LucideIcons,
