...
export const LISTINGS: Listing[] = [
  {
    ...
    description: "Komplexní cateringové služby pro firemní akce, svatby a soukromé oslavy.",
    city: { id: "loc-1", label: "Praha" },
    priceFrom: 12000,
  ...
  },
  {
    id: "102",
    name: "Místo pro akce",
    description: "Pronájem exkluzivního prostoru pro firemní i soukromé události až pro 200 osob.",
    city: { id: "loc-1", label: "Praha" },
    priceFrom: 45000,
